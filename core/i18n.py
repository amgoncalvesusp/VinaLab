...
class I18n:
    ...
    STRINGS = {
        ...
        "window_title": {"pt": "VinaLab Light v1.1.1", "en": "VinaLab Light v1.1.1"},
        "author_label": {
        ...
        "reference_ligand_filter": {
            "pt": "Ligante de referência (*.pdbqt *.pdb)",
            "en": "Reference ligand (*.pdbqt *.pdb)",
        },
        "docking_group": {
        ...
        "scoring_gnina_warn": {
            "pt": "GNINA não está disponível na versão Windows; use Linux/WSL se precisar da pontuação CNN.",
            "en": "GNINA is not available in the Windows version; use Linux/WSL if you need CNN scoring.",
        },
        "scoring_smina_warn": {
            "pt": "SMINA não foi encontrado. Instale smina e adicione ao PATH/Conda, ou coloque o executável em tools/smina.",
            "en": "SMINA was not found. Install smina and add it to PATH/Conda, or place the executable in tools/smina.",
        },
        ...
        "version_label": {"pt": "Versão 1.1.1", "en": "Version 1.1.1"},
        ...
        "pdf_footer": {
            "pt": "Gerado por VinaLab v1.1.1 | Adriano Marques Gonçalves — UNIARA | {date}",
            "en": "Generated by VinaLab v1.1.1 | Adriano Marques Gonçalves — UNIARA | {date}",
        },
        ...
        "rd_export_complex_pdb": {
            "pt": "Salvar também o complexo receptor+pose ({format})",
            "en": "Also save the receptor+pose complex ({format})",
        },
        "rd_receptor_missing": {
            "pt": "Receptor não encontrado para montar o complexo: {path}",
            "en": "Receptor not found to build the complex: {path}",
        },
        "rd_export_failed": {
            "pt": "A exportação parou após {exported} arquivo(s): {exc}",
            "en": "Export stopped after {exported} file(s): {exc}",
        },
        "rd_obabel_timeout": {
            "pt": "O Open Babel excedeu {seconds}s durante a conversão da pose.",
            "en": "Open Babel exceeded {seconds}s while converting the pose.",
        },
        "rd_obabel_conv_fail": {
