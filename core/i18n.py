...
class I18n:
    ...
    STRINGS = {
        ...
        "window_title": {"pt": "VinaLab v0.0.6", "en": "VinaLab v0.0.6"},
        "author_label": {
        ...
        "version_label": {"pt": "Versão 0.0.6", "en": "Version 0.0.6"},
        ...
        "pdf_footer": {
            "pt": "Gerado por VinaLab v0.0.6 | Adriano Marques Gonçalves — UNIARA | {date}",
            "en": "Generated by VinaLab v0.0.6 | Adriano Marques Gonçalves — UNIARA | {date}",
        },
