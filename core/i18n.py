...
class I18n:
    ...
    STRINGS = {
        ...
        "window_title": {"pt": "VinaLab Light v1.1.0", "en": "VinaLab Light v1.1.0"},
        "author_label": {
        ...
        "version_label": {"pt": "Versão 1.1.0", "en": "Version 1.1.0"},
        ...
        "pdf_footer": {
            "pt": "Gerado por VinaLab v1.1.0 | Adriano Marques Gonçalves — UNIARA | {date}",
            "en": "Generated by VinaLab v1.1.0 | Adriano Marques Gonçalves — UNIARA | {date}",
        },
        ...
        "rd_export_complex_pdb": {
            "pt": "Salvar também o complexo receptor+pose (.pdb)",
            "en": "Also save the receptor+pose complex (.pdb)",
        },
        "rd_receptor_missing": {
