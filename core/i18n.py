...
class I18n:
    ...
    STRINGS = {
        ...
        "pre_run_checklist": {"pt": "7. Checklist pré-execução", "en": "7. Pre-run Checklist"},
        ...
        "batch_mode": {"pt": "Modo Triagem (múltiplos ligantes)", "en": "Screening mode (multiple ligands)"},
        ...
        "docking_group": {"pt": "5. Parâmetros do AutoDock Vina", "en": "5. AutoDock Vina parameters"},
