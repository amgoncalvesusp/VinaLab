...
class I18n:
    ...
    STRINGS = {
        ...
        "window_title": {"pt": "VinaLab v1.0.0", "en": "VinaLab v1.0.0"},
        "author_label": {
        ...
        "scoring_gnina_warn": {
            "pt": "GNINA não detectado ou com DLLs nativas ausentes. No Windows, use Linux/WSL ou forneça um bundle GNINA completo em tools/gnina ou no PATH.",
            "en": "GNINA was not found or has missing native DLLs. On Windows, use Linux/WSL or provide a complete GNINA bundle in tools/gnina or PATH.",
        },
        ...
        "version_label": {"pt": "Versão 1.0.0", "en": "Version 1.0.0"},
        ...
        "pdf_footer": {
            "pt": "Gerado por VinaLab v1.0.0 | Adriano Marques Gonçalves — UNIARA | {date}",
            "en": "Generated by VinaLab v1.0.0 | Adriano Marques Gonçalves — UNIARA | {date}",
        },
